  ...
  return (
    ...
    <div style={styles.card}>
      ...
      <div style={styles.footer}>
        <Link href="/cadastro" style={styles.primaryLink}>Criar conta na plataforma</Link>
        <Link href="/recuperar-senha" style={styles.secondaryLink}>Esqueci minha senha</Link>
      </div>
    </div>
  );
}
